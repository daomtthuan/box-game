...
export class BelowObstacle implements Model {
  ...
  public constructor(props: { side1: number; side2: number; side3: number; angle1: number; angle2: number; color: Color }) {
    ...
    this.context.moveTo(0, this.height2);
    this.context.lineTo(this.width2, 0);
    this.context.lineTo(this.width, this.height1);
    this.context.lineTo(this.width1, this.height - this.side3);
    this.context.closePath();
    this.context.stroke();
    this.context.fillStyle = Color(this.color).lighten(0.15).string();
    this.context.fill();
    ...
    this.context.beginPath();
    this.context.moveTo(this.width1, this.height - this.side3);
    this.context.lineTo(this.width, this.height1);
