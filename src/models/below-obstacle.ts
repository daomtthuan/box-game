...
export class BelowObstacle implements Model {
  ...
  public constructor(props: { side1: number; side2: number; side3: number; angle1: number; angle2: number; color: Color }) {
    ...
    this.context.moveTo(0, height2);
    this.context.lineTo(width2, 0);
    this.context.lineTo(this.width, height1);
    this.context.lineTo(width1, this.height - this.side3);
    ...
    this.context.beginPath();
    this.context.moveTo(width1, this.height - this.side3);
    this.context.lineTo(this.width, height1);
